...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("content", sa.String(length=500), nullable=False, comment="事项内容（含申请原因原文）"),
        ...
        sa.Column("applicant_name", sa.String(length=128), nullable=False, comment="申请人（家长名·孩子名/活动名）"),
        ...
        sa.Column("handled_at", sa.DateTime(), nullable=True, comment="审计：处理时间（不参与显示态）"),
        sa.Column("handled_by", sa.BigInteger(), nullable=True, comment="审计：处理管理员ID（展示时 JOIN AdminUser 取名）"),
