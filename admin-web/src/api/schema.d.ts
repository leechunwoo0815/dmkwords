...
export interface paths {
    ...
    "/api/miniapp/children/{child_id}/avatar": {
        ...
        /**
         * Update Child Avatar
         * @description 家长给孩子选内置头像（只允许该字段；空串=清空回默认）。白名单校验在 service。
         */
        put: operations["update_child_avatar_api_miniapp_children__child_id__avatar_put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/miniapp/parent/profile": {
         ...
         * @description 只允许改展示称呼（display_name）；空串=回退真实姓名。
         */
        put: operations["update_parent_profile_api_miniapp_parent_profile_put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/miniapp/circle/posts/{post_id}": {
         ...
         * @description 家长删自己的帖（Q15 裁决：无 body——鉴权=parent token + post.parent_id 归属，
    ...
    "/api/miniapp/circle/children/{child_id}/profile": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Circle Child Profile
         * @description 孩子名片页（R4）：英文名/头像/成就数据 + 勋章墙 + TA 的帖子（隐私见 profile_service）。
         */
        get: operations["circle_child_profile_api_miniapp_circle_children__child_id__profile_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/miniapp/circle/children/{child_id}/poster": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Circle Child Poster
         * @description 名片海报图（R5；query token：image 组件无法带头——照报告图片先例）。
         */
        get: operations["circle_child_poster_api_miniapp_circle_children__child_id__poster_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/miniapp/circle/posts/{post_id}/thumb": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Circle Post Thumb
         * @description 帖子缩略图（无字纯图版，信息流小图；旧帖回落大图——post_thumb_image 内兜底）。
         */
        get: operations["circle_post_thumb_api_miniapp_circle_posts__post_id__thumb_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        ChildResponse: {
            ...
            /**
             * Avatar
             * @description WM15 系统内置头像 id（空=默认头像）
             */
            avatar?: string | null;
            /**
             * Has Orders
        ...
        ChildUpdateRequest: {
            ...
            /**
             * Avatar
             * @description WM15：系统内置头像 id（白名单校验）
             */
            avatar?: string | null;
        };
...
export interface operations {
    ...
    update_child_avatar_api_miniapp_children__child_id__avatar_put: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ChildAvatarRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    update_parent_profile_api_miniapp_parent_profile_put: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ParentProfileRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    circle_like_api_miniapp_circle_posts__post_id__like_post: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["CircleLikeRequest"] | null;
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    circle_child_profile_api_miniapp_circle_children__child_id__profile_get: {
        parameters: {
            query?: never;
            header: {
                authorization: string;
    ...
    circle_child_poster_api_miniapp_circle_children__child_id__poster_get: {
        parameters: {
            query?: {
                token?: string;
            };
    ...
    circle_post_thumb_api_miniapp_circle_posts__post_id__thumb_get: {
        parameters: {
            query?: {
                token?: string;
            };
