...
BOOKS = [
    ...
    ("Magic Tree House: Dinosaurs", "Mary Pope Osborne", 900, "3.5", "7-8岁（小学低年级）", "科普百科"),
    ("Charlotte's Web", "E. B. White", 3200, "4.8", "11-12岁（小学高年级）", "成长故事"),
    ("Matilda", "Roald Dahl", 3800, "5.2", "11-12岁（小学高年级）", "成长故事"),
    ("Charlie and the Chocolate Factory", "Roald Dahl", 3400, "4.9", "11-12岁（小学高年级）", "想象力"),
    ("The BFG", "Roald Dahl", 3600, "5.0", "13-15岁（初中）", "奇幻章节书"),
    ("Harry Potter and the Sorcerer's Stone", "J. K. Rowling", 7800, "6.1", "13-15岁（初中）", "奇幻章节书"),
    ("Percy Jackson: The Lightning Thief", "Rick Riordan", 8600, "5.8", "13-15岁（初中）", "奇幻章节书"),
    ("National Geographic Kids: Sharks", "Anne Schreiber", 1100, "3.8", "7-8岁（小学低年级）", "科普百科"),
    ...
    ("Magic School Bus: Inside the Earth", "Joanna Cole", 1500, "4.1", "9-10岁（小学中年级）", "科普百科"),
]
