...
def order_voucher_image(
    ...
    from backend.middleware.voucher_auth import assert_voucher_viewer

    assert_voucher_viewer(request, token, db)
    rel = OrderService.get_voucher_rel_path(db, order_id)
